...
* Download JDBC drivers (only those you need) from [Indexima Documentation](https://docs.indexima.com/latest/standalone-deployment/tech-guides/compatibility-matrix/data-source-compatibility-matrix)
